...
fn restore_success() {
    ...
    assert!(
        !core.tmp_file_contents_is_1(".latest.r.mockpcl.dd.txt"),
...
fn restore_using_partclone_fstype_variant_f2fs() {
    ...
    assert!(
        core.tmp_file_contents_is_1(".latest.r.mockpcl.f2fs.txt"),
...
fn restore_using_partclone_fstype_variant_ext2() {
    ...
    assert!(
        core.tmp_file_contents_is_1(".latest.r.mockpcl.ext2.txt"),
        "partclone.f2fs not invoke with -r"
    );
